...
var I18N = {
  ko: {
    ...
    // 오늘의 질문 화면
    'q.hint': '다 적었다면, 엔터.',
    'q.hint.answered': '오늘은 이미 답했어요. 고치고 싶으면 내용을 바꾸고 엔터.',
    'q.saving': '저장하는 중…',
    'q.saved': '고쳐서 저장했어요.',
    ...
    'q.wait.sub': '당신의 답은 잘 놓아두었어요.<br/>세 사람이 모이면, 이메일로 알려드릴게요.',
    ...
    'profile.mail': '답장이 오면, {mail}(으)로 알려 드립니다. 그 외에는 전혀 사용되지 않아요.',
  ...
  en: {
    ...
    'q.hint.answered': "You've already answered today. Edit it and press Enter to save your changes.",
    'q.saving': 'Saving…',
    ...
    'q.wait.sub': "Your answer is safely set aside.<br/>When three people gather, we'll let you know by email.",
    ...
    'profile.mail': "If a reply comes, we'll let you know at {mail}. It is used for nothing else.",
